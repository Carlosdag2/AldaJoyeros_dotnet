    ...
    public class MappingProfile : Profile
    {
        public MappingProfile()
        {
            ...
            CreateMap<Producto, ProductoDto>()
                ...
                .ForMember(dest => dest.Imagenes, opt => opt.Ignore()); // Las imágenes vienen de MongoDB ahora
            CreateMap<ProductoCreateDto, Producto>();
            CreateMap<ProductoUpdateDto, Producto>()
                .ForMember(dest => dest.Id, opt => opt.Ignore());

            // ProductoImagen mappings (MongoDB)
            CreateMap<ProductoImagenMongo, ProductoImagenDto>()
                .ForMember(dest => dest.ImagenBase64, opt => opt.MapFrom(src => src.ImagenBase64));
            CreateMap<ProductoImagenCreateDto, ProductoImagenMongo>()
                .ForMember(dest => dest.Id, opt => opt.Ignore())
            ...
            CreateMap<CarritoItem, CarritoItemDto>()
                ...
                .ForMember(dest => dest.Subtotal, opt => opt.MapFrom(src => src.Precio * src.Cantidad)); // ? NUEVO: Calcular subtotal
